...
function Cinema({ cinema, API_IMG }) {
  ...
  return (
    <>
      ...
      <ul className="flex justify-center items-center text-center p-20 bg-[#111111] lg:px-2 lg:py-10">
        <Swiper
          spaceBetween={20}
          slidesPerView={4}
      ...
      <Modal show={show} onHide={handleClose} className="absolute w-[780px] lg:w-[400px]  float-left  top-0 flex  justify-center items-center z-30 bg-[#333] p-4 m-center ">
        ...
        <Modal.Footer className="float-left">
          <Button variant="secondary" onClick={handleClose} className="bg-white text-[#171717] p-2 font-bold my-4">
            Kapat
          </Button>
        </Modal.Footer>
      </Modal>
